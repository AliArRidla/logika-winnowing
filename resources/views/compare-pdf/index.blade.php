        ...
        <section class="bg-dark py-5">
            <div class="container px-5 my-4 px-5">
                <div class="text-center mb-5">
                    ...
                    <h2 class="fw-bolder text-white">Compare PDF</h2>
                    <p class="lead mb-0 text-white">Please upload your pdf in this form</p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-12">
                      
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="{{route('compare-pdf.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf                            
                            <!-- Message input-->
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col input-group mb-3">
                                        <input type="file" name="pdf" class="form-control" id="inputGroupFile02">
                                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                                      </div>
                                      <div class="col input-group mb-3">
                                        <input type="file" name="pdf2" class="form-control" id="inputGroupFile02">
                                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                                      </div>                                    
                                </div>
                                <div class="row">
